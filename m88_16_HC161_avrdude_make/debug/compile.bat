...
avr-gcc  -gdwarf-2 -Wall -g -Os -funsigned-char -funsigned-bitfields -fpack-struct -fshort-enums  -mmcu=atmega88 -lprintf_min -lm -std=gnu99  -Wl,-u,vfprintf -lprintf_flt -lm  -c ../main.c 
